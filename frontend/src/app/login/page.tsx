    ...
    <div className="min-h-screen bg-bg-primary bg-noise flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-bg-secondary border border-border rounded-lg shadow-elevated p-8">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center"><span className="bg-bg-secondary px-3 text-xs text-text-muted uppercase tracking-wider">or</span></div>
        </div>
        <button
          onClick={() => { window.location.href = `${API_URL}/api/v1/auth/google/authorize`; }}
          className="w-full flex items-center justify-center gap-2.5 border border-border hover:border-accent/30 bg-bg-primary hover:bg-bg-surface text-text-secondary hover:text-text-primary py-2.5 rounded text-sm font-medium transition-all"
        >
